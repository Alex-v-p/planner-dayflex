...
> = {
  ...
  moved: {
    label: "Moved",
    cue: "M",
    description: "Moved later after unavailable time",
  ...
  split: {
    label: "Split",
    cue: "S",
    description: "Split around available time",
  ...
  incomplete: {
    label: "Inputs",
    cue: "I",
    description: "Saved inputs without a current plan",
    chipClass: "border-signal-600 bg-amber-50 text-signal-700",
    markerClass: "border-signal-600 bg-amber-50 text-signal-700",
  },
  no_useful_free_time: {
    label: "No free time",
    cue: "0",
    description: "Current plan without a useful free-time window",
